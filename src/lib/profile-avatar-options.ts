...
export const profileAvatarStyles: ProfileAvatarStyleOption[] = [
  { id: "thumbs", label: "Thumbs", description: "Começo leve e simpático para todo aluno.", cost: 0, starter: true },
  ...
  { id: "rings", label: "Rings", description: "Composição geométrica moderna.", cost: 150 },
  { id: "identicon", label: "Identicon", description: "Padrão digital com cara de tecnologia.", cost: 160 },
  ...
  { id: "fun-emoji", label: "Emoji", description: "Expressivo e f?cil de reconhecer.", cost: 220 },
  { id: "glass", label: "Glass", description: "Visual transl?cido e diferente.", cost: 230 },
  { id: "pixel-art", label: "Pixel Art", description: "Clima retro com jeito de jogo.", cost: 260 },
  { id: "pixel-art-neutral", label: "Pixel Art N", description: "Versão neutra do retro.", cost: 270 },
  { id: "croodles", label: "Croqui", description: "Rabiscado, divertido e diferente.", cost: 280 },
  { id: "croodles-neutral", label: "Croqui N", description: "Versão neutra rabiscada.", cost: 290 },
  { id: "bottts", label: "Robo", description: "Visual tecnológico e mais brincalhão.", cost: 320 },
  { id: "bottts-neutral", label: "Robo N", description: "Versão neutra dos robôs.", cost: 330 },
  { id: "big-ears", label: "Big Ears", description: "Personagens com traço marcante.", cost: 340 },
  { id: "big-ears-neutral", label: "Big Ears N", description: "Versão neutra dos Big Ears.", cost: 350 },
  { id: "adventurer", label: "Aventureiro", description: "Cartoon expressivo com cara de her?i.", cost: 360 },
  { id: "adventurer-neutral", label: "Aventureiro N", description: "Versão neutra do aventureiro.", cost: 370 },
  ...
  { id: "lorelei-neutral", label: "Lorelei N", description: "Versão neutra do estilo Lorelei.", cost: 530 },
  { id: "notionists", label: "Notionists", description: "Personagens cheios de personalidade.", cost: 560 },
  { id: "notionists-neutral", label: "Notionists N", description: "Versão neutra da coleção.", cost: 570 },
  ...
  { id: "avataaars", label: "Avatar cl?ssico", description: "Estilo premium com editor de acess?rios.", cost: 680, editable: true },
  { id: "avataaars-neutral", label: "Avatar N", description: "Versão neutra do avatar clássico.", cost: 690 },
];
...
export const avatarShopItems: AvatarShopItem[] = [
  ...
  },
  {
    ...
    label: "Óculos leitura 1",
    description: "Estilo clássico para sala de aula.",
    cost: 140,
  },
  {
  ...
  },
  {
    ...
    value: "shortFlat",
    label: "Corte liso",
    description: "Base inicial do avatar clássico.",
    cost: 0,
  },
  {
    id: "top:shortRound",
  ...
  },
  {
    ...
    value: "hoodie",
    label: "Moletom",
    description: "Opção inicial mais casual.",
    cost: 0,
  },
  {
    ...
    slot: "clothing",
    value: "graphicShirt",
    label: "Camiseta gráfica",
    description: "Visual descontraído e jovem.",
    cost: 180,
  },
  {
    id: "clothing:overall",
    ...
    value: "overall",
    label: "Jardineira",
    description: "Destaque rápido no avatar.",
    cost: 230,
  },
  {
